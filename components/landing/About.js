...
const milestones = [
  { year: '2021', title: 'Chapter Founded', desc: 'CSI was established at VIT Chennai with 50 founding members.' },
  ...
  { year: '2026', title: 'CSI Platform', desc: 'Launched the most advanced student tech community platform.' },
];
      ...
      <div className="max-w-7xl mx-auto px-6" ref={sectionRef}>
        ...
        <div className="text-center mb-20">
          ...
          <p className="max-w-2xl mx-auto text-lg text-[#a1a1aa] leading-relaxed">
            ...
            Our chapter at VIT Chennai is redefining what a student tech community can be.
          </p>
        </div>
