...
import { GitPullRequest, GitCommit, Users, Star, CircleDot } from 'lucide-react';
...
const issues = [
  { title: 'Add dark mode toggle to dashboard', repo: 'csi/web', labels: ['good first issue', 'enhancement'], difficulty: 'Easy' },
  { title: 'Fix mobile navigation overflow on iOS', repo: 'csi/web', labels: ['bug', 'mobile'], difficulty: 'Medium' },
  { title: 'Implement Redis caching for API responses', repo: 'csi/api', labels: ['performance', 'backend'], difficulty: 'Hard' },
  { title: 'Create unit tests for auth middleware', repo: 'csi/api', labels: ['good first issue', 'testing'], difficulty: 'Easy' },
  { title: 'Design system: Add new button variants', repo: 'csi/design', labels: ['design', 'ui'], difficulty: 'Medium' },
];
