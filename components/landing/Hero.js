  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at ${mousePos.x * 100}% ${mousePos.y * 100}%, rgba(6,182,212,0.15) 0%, transparent 50%),
                       radial-gradient(circle at ${(1 - mousePos.x) * 100}% ${(1 - mousePos.y) * 100}%, rgba(37,99,235,0.08) 0%, transparent 50%)`,
        }}
      />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute bottom-1/3 right-1/4 w-48 h-48 border border-blue-500/10 rounded-full animate-float-delay"
      ...
      <div className="absolute -right-20 top-1/2 -translate-y-1/2 w-[500px] h-[500px] pointer-events-none hidden xl:block">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-8 rounded-full border border-blue-500/10 animate-[spin_15s_linear_infinite_reverse]" />
