...
function BrainIcon(props) { return <Code2 {...props} />; }
function ShieldIcon(props) { return <Target {...props} />; }
function GlobeIcon(props) { return <Globe2 {...props} />; }
function CloudIcon(props) { return <Zap {...props} />; }
function HeartIcon(props) { return <Lightbulb {...props} />; }
function Globe2(props) { return <GlobeIconReal {...props} />; }
...
export default function Hackathon() {
  ...
  const tabs = [
    { key: 'tracks', label: 'Tracks', icon: Target },
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="glass-strong rounded-3xl p-10 md:p-16 mb-16 text-center overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <Link
              href="/login"
              className="btn-primary px-10 py-4 rounded-full text-lg font-semibold text-white inline-block"
            >
