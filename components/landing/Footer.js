...
import { GithubIcon, LinkedinIcon, TwitterIcon, InstagramIcon } from '@/components/landing/BrandIcons';
        ...
        <div className="glass-strong rounded-3xl p-10 md:p-16 mb-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/login"
                className="btn-primary px-10 py-4 rounded-full text-lg font-semibold text-white flex items-center gap-2"
              >
                Join Community
              ...
              <Link
                href="/login"
                className="btn-secondary px-10 py-4 rounded-full text-lg font-semibold text-white"
              >
                Partner with Us
              </Link>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/csi-logo.png" alt="CSI Logo" className="w-10 h-10 rounded-xl object-cover" />
              <span className="font-bold text-xl text-white">
                CSI
              </span>
            </div>
            <p className="text-[#a1a1aa] leading-relaxed mb-6 max-w-sm">
              The Computer Society of India — immersive, innovative, collaborative,
